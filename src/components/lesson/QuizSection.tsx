...
const QuizSection: React.FC<QuizSectionProps> = ({
  ...
  const handleQuizSubmit = () => {
    ...
    // Pass score and pass status to parent component
    onQuizComplete(score, isPassed);
      ...
      <Card>
        <CardContent className="p-6">
          {quizSet.questions.map((question: QuizQuestion, questionIndex: number) => (
            <div key={question.id} className={`mb-6 pb-6 ${questionIndex < quizSet.questions.length - 1 ? 'border-b' : ''}`}>
